...
{
    /// <inheritdoc />
    public partial class SetupDatabaseStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EvenWeekId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OddWeekId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Weeks_EvenWeekId",
                        column: x => x.EvenWeekId,
                        principalTable: "Weeks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Schedules_Weeks_OddWeekId",
                        column: x => x.OddWeekId,
                        principalTable: "Weeks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Semesters_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonTimes_TimeTables_TimeTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Lessons_LessonTimes_LessonTimeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonTimes_TimeTableId",
                table: "LessonTimes",
                column: "TimeTableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_EvenWeekId",
                table: "Schedules",
                column: "EvenWeekId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_OddWeekId",
                table: "Schedules",
                column: "OddWeekId");

            migrationBuilder.CreateIndex(
                name: "IX_Semesters_ScheduleId",
                table: "Semesters",
                column: "ScheduleId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Groups_Students_HeadStudentId",
                table: "Groups",
                column: "HeadStudentId",
